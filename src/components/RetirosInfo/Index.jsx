...
const RetiroInfo = ({setInfoDataScreen, rowSelected}) => {
    ...
    return(
        ...
        <div className="bg-primary w-3/4 h-4/7 lg:w-1/4 lg:inset-x-1/3 absolute z-10 left-10 top-[10%] rounded-3xl flex flex-col items-center py-2 gap-5">
            ...
            <h1 className="text-center text-tertiary text-xl">Informacion del retiro</h1>
            <div className="text-quinary flex flex-col px-5 gap-2 text-sm">
                ...
                <span><strong>Fecha de retiro: </strong>{transformFecha(rowSelected.fin_visita)}</span>
                    ...
                    if(rowSelected.conexion === "FIBRA"){
                        ...
                        return (
                            <>
                                ...
                                <span><strong>LAN MAC: </strong>{`${rowSelected.lan_mac}`}</span>
                            </>  
                            )
                    }
                })()}
