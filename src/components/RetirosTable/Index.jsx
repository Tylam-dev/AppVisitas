...
import { RetiroInfo } from "../RetirosInfo/Index";
...
const RetirosTable = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const request = await getDocs(collection(db,"retiros"))
                const datos = []
    ...
    return(
        ...
        <div className="w-full h-full">
            {(infoDataScreen)? <RetiroInfo setInfoDataScreen={setInfoDataScreen} rowSelected={rowSelected} setActualizar={setActualizar} actualizar={actualizar}/>:""}
